...
CRPresentActionSheet(NSString *title, NSString *msg, AlertAction handler, NSString *canel, NSString *action, ...)
{
    UIAlertController *alertCtrl = [UIAlertController alertControllerWithTitle:title message:msg preferredStyle:UIAlertControllerStyleActionSheet];
    if (canel) {
